// ─────────────────────────────────────────────────────────────
// Built-in debate personas
// ─────────────────────────────────────────────────────────────
// ai-consensus-core 0.10.0 stopped shipping the seven Roundtable
// personas — they're caller-owned content, not library mechanics.
// This MCP server is a caller, and its config-file UX depends on
// referencing personas by stable `personaId` strings, so we own
// the registry here.
//
// Users who want different voices can fork this file; a future
// feature could let configs declare inline persona objects.
